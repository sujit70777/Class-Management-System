...
public class AttendanceAdapter2 extends BaseAdapter {
    ...
    public AttendanceAdapter2(Context context, ArrayList<AttendanceInfo> attendanceInfoArrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        attendanceInfo = attendanceInfoArrayList.get(position);
        String id = attendanceInfo.getAttendanceDate();
